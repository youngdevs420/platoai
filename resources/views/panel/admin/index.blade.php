				...
				<div class="card">
					...
					<div class="card-body w-full !grow-0 mt-auto">
						...
						<div class="chart-navigation flex items-center gap-1 absolute top-2 end-2">
							<button type="button" id="btnPreviousMonth" class="inline-flex w-7 h-7 items-center justify-center border-none bg-none">
							...
							<button type="button" id="btnNextMonth" class="inline-flex w-7 h-7 items-center justify-center border-none bg-none">
