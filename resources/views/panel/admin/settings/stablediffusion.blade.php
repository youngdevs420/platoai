							...
							<div class="col-md-12">
								<div class="mb-3">
									...
									<select class="form-select" name="stablediffusion_default_language" id="stablediffusion_default_language">
										...
										<option value="th-TH" {{$settings_two->stablediffusion_default_language == 'th-TH' ? 'selected' : null}}>{{__('Thai (Thailand)')}}</option>
							...
							<div class="col-md-12">
								<div class="mb-3">
									...
									<select class="form-select" name="stablediffusion_default_model" id="stablediffusion_default_model">
										...
										<option value="stable-diffusion-v1-6" {{$settings_two->stablediffusion_default_model == 'stable-diffusion-v1-6' ? 'selected' : null}}>{{__('Stable Diffusion 1.6')}}</option>
										<option value="stable-diffusion-xl-beta-v2-2-2" {{$settings_two->stablediffusion_default_model == 'stable-diffusion-xl-beta-v2-2-2' ? 'selected' : null}}>{{__('Stable Diffusion 2.2.2 Beta')}}</option>
									</select>
								</div>
							</div>
{{-- 
